...
title КИТ-АЗС — Установка KIT.GasStation.Worker
...
set "SERVICE_DESC=Фоновая служба опроса ТРК по RS-485 и обмена данными (КИТ-АЗС)"
set "SERVICE_EXE=%~dp0KIT.GasStation.Worker.exe"
