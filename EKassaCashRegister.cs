...
namespace KIT.GasStation.EKassa
{
    public class EKassaCashRegister : ICashRegisterService
    {
        ...
        public async Task<CashRegisterState> GetShiftStateAsync()
        {
            ...
            return _cashRegister.Status switch
            {
                CashRegisterStatus.Unknown => new CashRegisterState
                {
                    Status = CashRegisterStatus.Unknown,
                },
                CashRegisterStatus.Open => new CashRegisterState
                {
                    Status = CashRegisterStatus.Open,
                },
                CashRegisterStatus.Close => new CashRegisterState
                {
                    Status = CashRegisterStatus.Close,
                },
                CashRegisterStatus.Exceeded24Hours => new CashRegisterState
                {
                    Status = CashRegisterStatus.Exceeded24Hours,
                },
                _ => new CashRegisterState
                {
                    Status = CashRegisterStatus.Unknown,
                },
            };
